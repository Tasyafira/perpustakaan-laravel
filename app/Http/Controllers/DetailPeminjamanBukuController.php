...
class DetailPeminjamanBukuController extends Controller
{
    ...
    public function detail($id){
        if(DetailPeminjamanBuku::where('id_detail_peminjaman_buku', $id)->exists()){
    ...
    public function update($id, Request $request) {         
        ...
        $ubah = DetailPeminjamanBuku::where('id_detail_peminjaman_buku', $id)->update([             
            'id_peminjaman_buku' =>$request->id_peminjaman_buku,
            'id_buku'            =>$request->id_buku,
            'qty'                =>$request->qty
        ]); 
    ...
    {
        $hapus = DetailPeminjamanBuku::where('id_detail_peminjaman_buku', $id)->delete();
